              ...
              <div class="drag-window"
                ...
                <div class="content-title">
                  ...
                  <span class="close-btn"
                        @click="close"></span>
                  <span v-if="hasMaxBtn"
                        :class="{'max-btn':!isMaxed,'nor-btn':isMaxed}"
                        @click="max"></span>
                </div>
                ...
                <div class="content-toolbar">
                  ...
                  <button v-if="hasConfirm"
                          class="toolbar_confirm"
                          @click="confirm">提交</button>
                  <button v-if="hasCancel"
                          class="toolbar_cancel"
                  ...
                  <button v-if="hasNext"
                          @click="next"
                          ref="nextBtn"
                          :class="curr === 2 ? 'disabled':'toolbar_other'">
                    下一步
                  </button>
                  <button v-if="hasPrev"
                          class="toolbar_other"
...
export default {
  ...
  data () {
    ...
    if (
      ...
      this.config.type == 'modify' ||
      this.config.type == 'modifyBatch'
    ) {
      hasConfirm = true;
      hasCancel = true;
      ...
      this.config.type == 'addSteps' ||
      this.config.type == 'modifySteps'
    ) {
      hasCancel = true;
      hasConfirm = true;
      hasPrev = true;
      hasNext = true;
    } else if (this.config.type == 'viewSteps') {
      hasClose = true;
      hasPrev = true;
      hasNext = true;
    } else {
