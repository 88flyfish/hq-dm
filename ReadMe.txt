...
5、cd 到该文件夹下， 命令行输入:npm install --registry=http://192.168.1.210:8081/nexus/content/repositories/npm/ 对项目的依赖进行下载安装
...
或者淘宝的私服: npm install --registry=http://registry.npm.taobao.org
